...
const (
	...
	ButtonMiddle Button = Button(glfw.MouseButtonMiddle)
)

type Action int

const (
	ActionPress   Action = Action(glfw.Press)
	ActionRelease Action = Action(glfw.Release)
	ActionRepeat  Action = Action(glfw.Repeat)
)

func (a Action) Press() bool {
	return a == ActionPress
}

func (a Action) Release() bool {
	return a == ActionRelease
}

func (a Action) Repeat() bool {
	return a == ActionRepeat
}
...
func (a Action) String() string {
	...
	case ActionRepeat:
		return "ActionRepeat"
	default:
		panic(fmt.Errorf("String on unknown Action: %v", a))
	}
}
